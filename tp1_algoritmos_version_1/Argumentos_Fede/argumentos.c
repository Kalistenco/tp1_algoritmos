...
bool_t argumentos_error_imprimir(status_arg_t estado){
        ...
        switch(estado){
            ...
            case ERROR_TIPO_SALIDA_NO_ESPECIFICADO:
                fprintf(stderr , "%s: %s\n" ,MSJ_ERROR ,MSJ_ARG_TIPO_SALIDA);
                break;
            case ERROR_TIPO_SALIDA_INV:
                fprintf(stderr , "%s: %s\n", MSJ_ERROR , MSJ_ARG_TIPO_SALIDA_INV);
                break;
            case ERROR_NOMBRE_SALIDA_NO_ESPECIFICADO:
                fprintf(stderr , "%s: %s\n", MSJ_ERROR ,MSJ_ARG_NOMBRE_SALIDA);
                break;
            case ERROR_TIPO_ENTRADA_NO_ESPECIFICADO:
                fprintf(stderr , "%s: %s\n" , MSJ_ERROR ,MSJ_ARG_TIPO_ENTRADA);
                break;
            case ERROR_TIPO_ENTRADA_INV:
                fprintf(stderr , "%s: %s\n" ,MSJ_ERROR , MSJ_ARG_TIPO_ENTRADA_INV);
                break;
            case ERROR_NOMBRE_ENTRADA_NO_ESPECIFICADO:
                fprintf(stderr , "%s: %s\n" ,MSJ_ERROR ,MSJ_ARG_NOMBRE_ENTRADA);
                break;
